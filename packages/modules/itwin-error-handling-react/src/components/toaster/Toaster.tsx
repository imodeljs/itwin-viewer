...
export default class Toaster {
  ...
  public success(text: string, settings?: IToastOptions) {
  ...
  public informational(text: string, settings?: IToastOptions) {
    if (this.notifyHandler) {
      this.notifyHandler({
  ...
  public error(text: string, settings?: IToastOptions) {
    if (this.notifyHandler) {
      this.notifyHandler({
        category: "error",
        duration: settings && settings.duration ? settings.duration : undefined,
